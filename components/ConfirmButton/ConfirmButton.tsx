	...
	return (
		<>
			<button
				...
				className={`flex justify-center items-center self-center gap-1 max-w-fit px-3 outline-none rounded-lg ${
					isDisable ? "cursor-not-allowed text-black bg-slate-500 opacity-50" : "cursor-pointer text-white bg-green-500"
				}`}
				type="submit"
				disabled={isDisable}>
				<svg
					data-testid="confirm-button-svg"
				...
				<span data-testid="confirm-button-span" className="mt-2">
					{btnText}
				</span>
			</button>
		</>
