	...
	return (
		<>
			<ul
				...
				className="w-full mt-9 px-2 text-center rounded-2xl text-[0.75rem] sm:text-base bg-white text-black hover:cursor-pointer transition-all duration-500">
				{results.map((result: { item: any }) => {
					return (
